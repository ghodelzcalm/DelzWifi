...
HACK PW WIFI TETANGGA 🤪

\n\t\t\033[1;36m@GHODELZCALM 
                                                    \n\t\t[\033[1;32m*\033[1;37m] NAME        : Ghodelz Calm\n\t\t[\033[1;32m*\033[1;37m] WORK ONLY   : GREEN-COLOR WIFI\n\t\t[\033[1;32m*\033[1;37m] AUTHOR      : ghodelz \n\t\t[\033[1;32m*\033[1;37m] Version     : DELZWIFI \n\t\t[\033[1;32m*\033[1;37m] TIKTOK      : @ghodelzcalm \n''')
...
def usage():
    return """
Ghodelzcalm 0.0.1 (c) 2025 rofl0r (modified).

%(prog)s birihack.py <arguments>
 Required arguments:
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='Ghodelzcalm 0.0.1 (c) 2025 rofl0r (modified).',
        ...
        try:
            ...
            if args.loop:
                if input("\n[?] Exit the script (otherwise continue to AP scan)? [N/y] ").lower() == 'y':
                    ani("\n[\033[1;31m!\033[1;37m] Create by ghodelz calm ☕…")
                    break
                else:
                    args.bssid = None
            else:
                ani("\n[\033[1;31m!\033[1;37m]script berhenti @ghodelzcalm ☕…")
                break
